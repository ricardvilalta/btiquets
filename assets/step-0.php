...
<div class="container">    
    <ul class="actions">
        <li>
            ...
            if($valid==1)
            {?>
            <a href="#one" class="button special scrolly"><?php if($box['etype']==2 || $box['etype']==3) echo translate("Comença la reserva", $lang); else if($box['etype']==4 || $box['etype']==5 || $box['etype']==6) echo translate("Comença la compra", $lang); else echo translate("Comença la inscripció", $lang); ?></a>
            <?php
            }
            else if($valid==-1)
            {?>
