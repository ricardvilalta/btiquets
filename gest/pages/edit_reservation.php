...
<script type="text/javascript">
    ...
    $('.pop_up_content').ready(function() {
                ...
                $('#nova_dada').click(function() {
                    $('#dades').append(
                        '<div class="row dades_linia">\
                            ...
                            <div class="form-group col-sm-6">\
                                <label>EMAIL</label>\
                                <input class="form-control camp_4" type="text" value=""/>\
                            </div>\
                            <div class="form-group col-sm-4">\
                                <label>MUNICIPI</label>\
                                <input class="form-control camp_5" type="text" value=""/>\
                            </div>\
                            <div class="form-group col-sm-2">\
                                <label>EDAT</label>\
                                <select class="form-control camp_6">\
                                    <option value="1">0-11 anys</option>\
                                    <option value="2">12-17 anys</option>\
                                    <option value="3">31-60 anys/option>\
                                    <option value="2">+60 anys</option>\
                                </select>\
                            </div>\
                        </div>'
                    );
        ...
        $('#nova_dada').click(function() {
            ...
            if ($('#boxid').val() == "502" || $('#boxid').val() == "510" || $('#boxid').val() == "511") {
                $('#dades').append(
                    '<div class="row dades_linia">\
                        <div class="form-group col-sm-2">\
                            <label>GÈNERE</label>\
...
<div class="row">
    <div class="col-lg-12">
        ...
        <input id="boxid" type="hidden" value="<?php echo $box_id; ?>" />
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group vtype1 vtype2 vtype3 vtype4 vtype5 vtype7">
                            ...
                            <select id="edit_state" class="form-control" name="edit_state">
                                <option id="edit_state_0" value="-2" <?php if ($estat == -2) echo 'selected'; ?>><?php if ($session_id == -2) echo translate('Reserva en curs', $lang);
                                                                                                                else echo translate('Pagament en curs', $lang); ?></option>
                                <option id="edit_state_1" value="-1" <?php if ($estat == -1) echo 'selected'; ?>><?php if ($session_id == -2) echo translate('Reserva denegada', $lang);
                                                                                                                else echo translate('Pagament denegat', $lang); ?></option>
                                <option id="edit_state_2" value="0" <?php if ($estat == 0) echo 'selected'; ?>><?php if ($session_id == -2) echo translate('Reserva enviada', $lang);
                                                                                                            else echo translate('Pendent de pagament', $lang); ?></option>
                                <option id="edit_state_3" value="1" <?php if ($estat == 1) echo 'selected'; ?>><?php if ($session_id == -2) echo translate('Reserva acceptada', $lang);
                                                                                                            else echo translate('Reserva correcta', $lang); ?></option>
                                <option id="edit_state_4" value="2" <?php if ($estat == 2) echo 'selected'; ?>><?php if ($session_id == -2) echo translate('Reserva realitzada', $lang);
                                                                                                            else echo translate('Activitat realitzada', $lang); ?></option>
                                <option id="edit_state_5" value="3" <?php if ($estat == 3) echo 'selected'; ?>><?php if ($session_id == -2) echo translate('Pre-reserva', $lang);
                                                                                                            else echo translate('Pre-reserva', $lang); ?></option>
                            </select>
                        </div>
                        <div class='form-group vtype1 vtype2 vtype3 vtype4 vtype5 vtype7'>
                                        ...
                                        foreach ($dades_info as $dades_iter) { ?>
                                            <div class="row dades_linia">
                                                <div class="form-group col-sm-2">
                                                    <label>GÈNERE</label>
                                                    <select class="form-control camp_1">
                                                        <option value="-1" <?php if ($dades_iter['camp_1'] <= 0) echo 'selected'; ?>>-</option>
                                                        <option value="1" <?php if ($dades_iter['camp_1'] == 1) echo 'selected'; ?>>Home</option>
                                                        <option value="2" <?php if ($dades_iter['camp_1'] == 2) echo 'selected'; ?>>Dona</option>
                                                        <option value="3" <?php if ($dades_iter['camp_1'] == 3) echo 'selected'; ?>>No binari</option>
                                                    </select>
                                                </div>
                                                <div class='form-group col-sm-6'>
                                                    <label>NOM</label>
                                                    <input class="form-control camp_2" type="text" value="<?php echo $dades_iter['camp_2']; ?>" />
                                                </div>
                                                <div class='form-group col-sm-4'>
                                                    <label>DNI</label>
                                                    <input class="form-control camp_3" type="text" value="<?php echo $dades_iter['camp_3']; ?>" />
                                                </div>
                                                <div class="form-group col-sm-12">
                                                    <label>MENOR</label>
                                                    <input class="camp_4" type="checkbox" <?php if ($dades_iter['camp_4'] == '1') echo 'checked'; ?>>
                                                </div>
                                            </div>
                                    <?php
                                        }
                                    ...
                                    if ($dades_info != null) {
                                        foreach ($dades_info as $dades_iter) { ?>
                                            <div class="row dades_linia">
                                                ...
                                                <div class='form-group col-sm-6'>
                                                    <label>EMAIL</label>
                                                    <input class="form-control camp_4" type="text" value="<?php echo $dades_iter['camp_4']; ?>" />
                                                </div>
                                                <div class='form-group col-sm-3'>
                                                    <label>MUNICIPI</label>
                                                    <input class="form-control camp_5" type="text" value="<?php echo $dades_iter['camp_5']; ?>" />
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    <label>EDAT</label>
                                                    <select class="form-control camp_6">
                                                        <option value="1" <?php if ($dades_iter['camp_6'] == 1) echo 'selected'; ?>>0-11 anys</option>
                                                        <option value="2" <?php if ($dades_iter['camp_6'] == 2) echo 'selected'; ?>>12-17 anys</option>
                                                        <option value="3" <?php if ($dades_iter['camp_6'] == 3) echo 'selected'; ?>>31-60 anys</option>
                                                        <option value="4" <?php if ($dades_iter['camp_6'] == 4) echo 'selected'; ?>>+60 anys</option>
                                                    </select>
                                                </div>
                                            </div>
                                    <?php
