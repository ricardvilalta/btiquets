<?php
    ...
    {
        $reserves = GetReservationList($mysqli);
    }
    else
    {        
        $reserves = GetReservationList($mysqli,$compte['id']);
    }    
    //$boxlist = GetBoxListAdmin($mysqli,-1,$_SESSION["user_id"]);
    if($_SESSION['user_id']==$SUPERUSER && $accountuid<0)
    {
...
<script type="text/javascript">
    ...
    {                
        ...
        $('#edit_res').click(function(){
            ...
            if(id!=undefined)
            {
                window.location.href = '/admin/edit-reservation/' + id;
            }
        });
        ...
        $('#export_res').click(function(){
            ...
            $('#did3').val($('#data_type_3').val());
            $('#did4').val($('#data_type_4').val());
...
//            if(rdata_ini!="")
//            {
//                var dateini = rdata_ini.split("-");
//                dini = new Date(dateini[2],dateini[1]-1,dateini[0]);
//            }
//            if(rdata_fin!="")
//            {
//                var datefin = rdata_fin.split("-");
//                dfin = new Date(datefin[2],datefin[1]-1,datefin[0]);
//            }
//
//            // Comprovacions
...
//                $('#reserves tr.table_content:visible').each(function() {
//
//                    var dline = new Date($(this).attr("rdata"));
//                    dline.setHours(0);
//                    if(dline<dini || dline>dfin)
//                    {
//                        $(this).hide();
        ...
        <div class="panel panel-default">
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="/admin/edit-reservation/-1">Nova reserva</a>
                            </li>
            ...
            <div class="panel-body">
                ...
                <form id="export_form" action="<?php echo $rootfolder . 'php/export_dataset.php'; ?>" method="post" target="_blank">
                    <input id="tid" name="tid" type="hidden" value="-999">
                    <input id="xid" name="xid" type="hidden" value="-1">
                    <input id="sid" name="sid" type="hidden" value="-1">
                    <input id="uid" name="uid" type="hidden" value="-1">
                    <input id="did1" name="did1" type="hidden" value="">
                    <input id="did2" name="did2" type="hidden" value="">
                    <input id="did3" name="did3" type="hidden" value="">
                    <input id="did4" name="did4" type="hidden" value="">
                </form>
...
<!--                                        <td><?php echo $data_3; ?></td>-->
                                        ...
                                        <td><?php if($reserva['box_id']==-1) echo $reserva['nom_exp']; else echo $activitats[$reserva['box_id']]; ?></td>
                                        <td>
                                        <?php 
                                        if($box['etype']==5)
                                        {
                                        ...
                                        <td style="white-space: nowrap;"><?php if($box['etype']<=1) echo $estat_reserva_1[$reserva['confirmat']]; else if($box['etype']==4 || $box['etype']==5 || $box['etype']==7) echo $estat_reserva_3[$reserva['confirmat']]; else echo $estat_reserva_2[$reserva['confirmat']]; ?></td>
                                        <?php
                                        if($_SESSION['user_id']==$SUPERUSER)
                                        {
                                        ?>
