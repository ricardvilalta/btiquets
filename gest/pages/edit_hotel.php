<?php
    ...
    if($id>0)
    {   
        $sql="SELECT name,poblacio,mail,tel,web,description,type,modalitat,propietari,ocult,name_es,description_es,name_en,description_en,modalitat_es,modalitat_en,mail_aux FROM allotjaments WHERE id='$id'";
        ...
        $cap_modalities = decode_cap($capacitat,true);
        $cap_es_modalities = decode_cap($capacitat_es,true);
        $cap_en_modalities = decode_cap($capacitat_en,true);
        
        // tb he d'agafar totes les imatges de la carpeta /boxes/box_id
        $imglist = GetFolderImages("../../allotjaments/all_" . $id);               
    }
    else
    {
        $name = "";
    ...
    $(document).ready(function()
    {
        $(function () {
            ...
            $('#fileupload_0').fileupload({
                url: url,
                formData: {
                    path: '<?php echo $rootfolder . "allotjaments/all_" . $id . "/"; ?>',
                    name: 'all_image_0.jpg',
                },
                dataType: 'json',
                ...
                imageMaxWidth: 1500,
                    ...
                    str = str + '<?php echo $rootfolder; ?>' + 'allotjaments/all_';
                    str += '<?php echo $id; ?>';
                    str += '/';
        ...
        function initialize()
        {
            ...
            {?>            
                ...
                img.src = '<?php echo $rootfolder . "allotjaments/all_" . $id . "/all_image_" . $i . ".jpg?nocache=" . rand(); ?>';
            <?php
            } 
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edita l'allotjament</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            ...
                            <div class="form-group">
                                <label>Nom de l'allotjament</label>
                            ...
                            <div class="form-group">
                                <label>Descripció de l'allotjament</label>
                    ...
                    <div class="col-lg-6">                        
                        <div id="payment_mod">
                            <h2>Modalitats d'allotjaments/habitacions</h2>
                            <div class="form-group">
