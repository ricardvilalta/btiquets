<?php
    ...
    {
        $boxlist = GetHotelListAdmin($mysqli,-1);
    }
    else
    {
        $compte = GetAccountfromUserInfo($mysqli,$_SESSION['user_id']);
        $boxlist = GetHotelListAdmin($mysqli,-1,$compte['id']);
    }     
?>
            ...
            if(id!=undefined)
            {
                if(confirm('<?php echo translate("N\'estàs segur?", $lang); ?>'))
                {
                    ...
                    }).always(function(ret)
                    {
                        ...
                        {
                            alert('<?php echo translate("Aquest allotjament té reserves actives", $lang); ?>'); 
                        }
                    });
                }
            }
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Allotjaments</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-tasks fa-fw"></i> Llista d'allotjaments
                <div class="pull-right">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li><a href="/admin/edit-hotel/-1">Nou allotjament</a>
                            </li>
                            <li><a id="edit_hotel">Edita allotjament</a>
                            </li>
                            <li><a id="copy_hotel">Copia allotjament</a>
                            </li>
                            <li><a id="delete_hotel">Elimina allotjament</a>
                            </li>
                        </ul>
                    </div>
                </div>
